                        ...
                        <div className="flex flex-col md:flex-row justify-center gap-10 md:gap-12">
                            ...
                            <div className="flex flex-col p-6 max-w-[352px] text-gray-0d0d0d bg-white rounded-[20px] border border-black-10-percent shadow">
                                ...
                                <button
                                    ...
                                    className="w-full text-white text-base font-medium text-center bg-blue-29a8f1 hover:bg-blue-0e90da focus:outline-none focus:ring-4 focus:ring-blue-300 rounded-[10px] px-11 py-2.5 cursor-pointer"
                                >
                                    Get Started
                                </button>
                            </div>
