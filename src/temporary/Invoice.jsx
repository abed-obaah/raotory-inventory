                    ...
                    <div className='flex flex-col justify-between p-6'>
                        ...
                        <div className='flex items-center gap-x-10'>
                            ...
                            <div>
                                ...
                                <input type="date" className="bg-white-f8fdff rounded-[5px] text-xs text-gray-757575 font-semibold p-2.5" />
                            </div>
                            {/* End date */}
                            <div>
                            ...
                            <form class="">
                                ...
                                <select id="" class="bg-white-f8fdff text-gray-757575 text-sm rounded-[5px] block w-full p-2">
                    ...
                    <div className="w-full">
                        <form class="flex items-center mx-auto">   
                            <div class="relative w-full">
                                ...
                                <input type="text" id="voice-search" class="bg-white border border-black-10-percent text-gray-757575 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 placeholder-gray-b4b4b4  dark:bg-white dark:border-black-10-percent dark:placeholder-gray-b4b4b4 dark:text-gray-757575 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search by customer name" />
                            </div>
                        </form>
                    </div>
                    {/* Button */}
                    <div>
                        <button className="bg-blue-500 text-white px-11 py-2.5 rounded-[10px] w-full whitespace-nowrap">
                            View Held Receipts
                        </button>
                    </div>
                </div>
                ...
                <div className="relative overflow-x-auto mb-10">
                    <table className="text-base w-full">
                        ...
                        <tbody className='flex flex-col gap-y-5'>
                            <tr className="grid grid-cols-6 bg-white border border-gray-e5e5e5 rounded-[10px]">
